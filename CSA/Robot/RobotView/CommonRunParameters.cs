...
namespace RobotView
{
    public partial class CommonRunParameters : UserControl
    {
...
#else
        private float speed, acceleleration;
        ...
        public float Speed
        {
            get {
                return speed;
                //return (float)upDownSpeed.Value / 1000;
            }
            set {
                upDownSpeed.Value = (decimal)value * 1000;
                speed = value;
            }
        }
        ...
        private void buttonEditSpeed_Click(object sender, EventArgs e)
        {
            ...
            nk.Number = (float)upDownSpeed.Value;
        ...
        {
            NumberKeyboard nk = new NumberKeyboard();
            nk.Number = (float)upDownAcceleration.Value;
            if (nk.ShowDialog() == DialogResult.OK)
            {
